...
struct ReplayLiqSidebandStats {
  ...
  std::uint64_t w2_retire_record_lifecycle_clear_fallback_capture_physical_clear = 0;
  std::uint64_t w2_retire_record_lifecycle_clear_fallback_candidate = 0;
  std::uint64_t w2_retire_record_lifecycle_clear_fallback_duplicate_physical_clear = 0;
  std::uint64_t w2_retire_record_lifecycle_clear_fallback_clear_valid = 0;
  ...
  std::uint64_t w2_retire_record_rf_fallback_capture_physical_writeback = 0;
  std::uint64_t w2_retire_record_rf_fallback_candidate = 0;
  std::uint64_t w2_retire_record_rf_fallback_duplicate_physical_writeback = 0;
  std::uint64_t w2_retire_record_rf_fallback_writeback_valid = 0;
  std::uint64_t w2_retire_record_wakeup_fallback_capture_physical_wakeup = 0;
  std::uint64_t w2_retire_record_wakeup_fallback_candidate = 0;
  std::uint64_t w2_retire_record_wakeup_fallback_duplicate_physical_wakeup = 0;
  std::uint64_t w2_retire_record_wakeup_fallback_wakeup_valid = 0;
  std::uint64_t w2_retire_record_fallback_owner_policy_candidate = 0;
  ...
  std::uint64_t w2_retire_record_model_order_record_candidate = 0;
  std::uint64_t w2_retire_record_model_order_return_side_effects_ready = 0;
  std::uint64_t w2_retire_record_model_order_retire_clear_evidence_ready = 0;
  std::uint64_t w2_retire_record_model_order_return_then_retire_ready = 0;
  std::uint64_t w2_retire_record_model_order_fallback_owner_eligible = 0;
  std::uint64_t w2_retire_record_model_order_blocked_by_missing_return_side_effect = 0;
  std::uint64_t w2_retire_record_model_order_blocked_by_missing_retire_clear_evidence = 0;
  std::uint64_t w2_retire_record_model_order_blocked_by_owner_disabled = 0;
  std::uint64_t w2_retire_record_default_promotion_record_candidate = 0;
  std::uint64_t w2_retire_record_default_promotion_pre_arm_model_order_ready = 0;
  std::uint64_t w2_retire_record_default_promotion_any_physical_duplicate = 0;
  std::uint64_t w2_retire_record_default_promotion_ready = 0;
  std::uint64_t w2_retire_record_default_promotion_blocked_by_no_record = 0;
  std::uint64_t w2_retire_record_default_promotion_blocked_by_missing_fallback_candidate = 0;
  ...
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_transfer_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppression_required = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_physical_bundle_complete = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_atomic_suppress_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppress_rob_complete = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppress_rf_writeback = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppress_wakeup = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppress_lifecycle_clear = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_suppress_mask_sum = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_all_or_none_suppress = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_blocked_by_no_transfer_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_blocked_by_no_suppression_requirement = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_plan_blocked_by_incomplete_physical_bundle = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_probe_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_probe_enabled_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_probe_selected = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_probe_selected_mask_sum = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_probe_all_or_none_input_mask = 0;
  ...
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_capture_identity = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_captured_identity_valid = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_registered_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_retained_record_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_lifecycle_row_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_lifetime_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_eligible_registered_mask = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_blocked_by_no_captured_identity = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_blocked_by_missing_record = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_blocked_by_rid_mismatch = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_identity_blocked_by_load_lsid_mismatch = 0;
  ...
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_enabled_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_suppress_rob_complete = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_suppress_rf_writeback = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_suppress_wakeup = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_suppress_lifecycle_clear = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_suppress_mask_sum = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_all_or_none = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_blocked_by_live_mask_disabled = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_live_mask_blocked_by_no_eligible_ownership = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_candidate = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_full_mask = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_fire_complete_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_clear_intent_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_live_clear_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_row_fill_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_lifecycle_clear_suppressed = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_all_clear_aligned = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_partial_mask = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_no_fire_complete = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_no_clear_intent = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_no_live_clear = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_no_row_fill = 0;
  std::uint64_t w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_lifecycle_clear_still_enabled = 0;
...
void observe_replay_liq_sideband(const VLinxCoreFrontendFetchRfAluTraceTop &dut) {
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordLifecycleClearFallbackCapturePhysicalClear) {
    ++g_replay_liq_sideband_stats.w2_retire_record_lifecycle_clear_fallback_capture_physical_clear;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordLifecycleClearFallbackCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_lifecycle_clear_fallback_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordLifecycleClearFallbackDuplicatePhysicalClear) {
    ++g_replay_liq_sideband_stats.w2_retire_record_lifecycle_clear_fallback_duplicate_physical_clear;
  }
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordRfFallbackCapturePhysicalWriteback) {
    ++g_replay_liq_sideband_stats.w2_retire_record_rf_fallback_capture_physical_writeback;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordRfFallbackCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_rf_fallback_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordRfFallbackDuplicatePhysicalWriteback) {
    ++g_replay_liq_sideband_stats.w2_retire_record_rf_fallback_duplicate_physical_writeback;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordRfFallbackWritebackValid) {
    ++g_replay_liq_sideband_stats.w2_retire_record_rf_fallback_writeback_valid;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordWakeupFallbackCapturePhysicalWakeup) {
    ++g_replay_liq_sideband_stats.w2_retire_record_wakeup_fallback_capture_physical_wakeup;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordWakeupFallbackCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_wakeup_fallback_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordWakeupFallbackDuplicatePhysicalWakeup) {
    ++g_replay_liq_sideband_stats.w2_retire_record_wakeup_fallback_duplicate_physical_wakeup;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordWakeupFallbackWakeupValid) {
    ++g_replay_liq_sideband_stats.w2_retire_record_wakeup_fallback_wakeup_valid;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordFallbackOwnerPolicyCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_fallback_owner_policy_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordFallbackOwnerPolicyAllCandidatesReady) {
    ++g_replay_liq_sideband_stats.w2_retire_record_fallback_owner_policy_all_candidates_ready;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordFallbackOwnerPolicyBlockedByPhysicalDuplicate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_fallback_owner_policy_blocked_by_physical_duplicate;
  }
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordFallbackOwnerPolicyBlockedByGlobalFallbackDisabled) {
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderRecordCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_record_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderReturnSideEffectsReady) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_return_side_effects_ready;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderRetireClearEvidenceReady) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_retire_clear_evidence_ready;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderReturnThenRetireReady) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_return_then_retire_ready;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderFallbackOwnerEligible) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_fallback_owner_eligible;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderBlockedByMissingReturnSideEffect) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_blocked_by_missing_return_side_effect;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderBlockedByMissingRetireClearEvidence) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_blocked_by_missing_retire_clear_evidence;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordModelOrderBlockedByOwnerDisabled) {
    ++g_replay_liq_sideband_stats.w2_retire_record_model_order_blocked_by_owner_disabled;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionRecordCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_default_promotion_record_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionPreArmModelOrderReady) {
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionAnyPhysicalDuplicate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_default_promotion_any_physical_duplicate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionReady) {
    ++g_replay_liq_sideband_stats.w2_retire_record_default_promotion_ready;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionBlockedByNoRecord) {
    ++g_replay_liq_sideband_stats.w2_retire_record_default_promotion_blocked_by_no_record;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordDefaultPromotionBlockedByMissingFallbackCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_default_promotion_blocked_by_missing_fallback_candidate;
  }
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanTransferCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_transfer_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanSuppressionRequired) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppression_required;
  }
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanSuppressRobComplete) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppress_rob_complete;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanSuppressRfWriteback) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppress_rf_writeback;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanSuppressWakeup) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppress_wakeup;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanSuppressLifecycleClear) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppress_lifecycle_clear;
  }
  g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_plan_suppress_mask_sum +=
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanBlockedByNoTransferCandidate) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_plan_blocked_by_no_transfer_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanBlockedByNoSuppressionRequirement) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_plan_blocked_by_no_suppression_requirement;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressPlanBlockedByIncompletePhysicalBundle) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_plan_blocked_by_incomplete_physical_bundle;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_probe_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeEnabledCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_probe_enabled_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeSelected) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_probe_selected;
  }
  g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_probe_selected_mask_sum +=
    dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeSelectedMask;
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeBlockedByProbeDisabled) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressProbeBlockedByPartialMask) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityCaptureIdentity) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_identity_capture_identity;
  }
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityRetainedRecordAligned) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityLifetimeAligned) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_identity_lifetime_aligned;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityEligibleRegisteredMask) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_identity_eligible_registered_mask;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityBlockedByNoCapturedIdentity) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityBlockedByMissingLifecycleEvidence) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressIdentityBlockedByNotFullMask) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskSuppressRfWriteback) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_live_mask_suppress_rf_writeback;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskSuppressWakeup) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_live_mask_suppress_wakeup;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskSuppressLifecycleClear) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_live_mask_suppress_lifecycle_clear;
  }
  g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_live_mask_suppress_mask_sum +=
      dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskSuppressMask;
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskAllOrNone) {
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressLiveMaskBlockedByNoEligibleOwnership) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_live_mask_blocked_by_no_eligible_ownership;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofCandidate) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_clear_proof_candidate;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofFullMask) {
    ++g_replay_liq_sideband_stats.w2_retire_record_physical_bundle_suppress_clear_proof_full_mask;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofFireCompleteAligned) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_clear_proof_fire_complete_aligned;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofClearIntentAligned) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_clear_proof_clear_intent_aligned;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofLiveClearAligned) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofLifecycleClearSuppressed) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofBlockedByPartialMask) {
    ++g_replay_liq_sideband_stats
      .w2_retire_record_physical_bundle_suppress_clear_proof_blocked_by_partial_mask;
  }
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofBlockedByNoFireComplete) {
    ++g_replay_liq_sideband_stats
  ...
  if (dut.io_reducedLoadReplayLiqLretPipeW2RetireRecordPhysicalBundleSuppressClearProofBlockedByNoRowFill) {
    ++g_replay_liq_sideband_stats
