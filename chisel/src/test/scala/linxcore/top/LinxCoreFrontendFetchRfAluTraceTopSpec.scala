...
class LinxCoreFrontendFetchRfAluTraceTopSpec extends AnyFunSuite {
  ...
  test("interface combines live fetch source with RF-backed issue and ALU diagnostics") {
    ...
    assert(io.bfuBodyValid.getWidth == 1)
    assert(io.bfuHeaderPc.getWidth == 64)
    assert(io.bfuHSizeBytes.getWidth == 64)
    assert(io.bfuBSizeBytes.getWidth == 64)
    assert(io.bfuStaticGeometryValid.getWidth == 1)
    assert(io.bfuStaticHeaderActive.getWidth == 1)
    assert(io.bfuStaticLearnedFire.getWidth == 1)
    assert(io.bfuStaticResolvedLearnedFire.getWidth == 1)
    assert(io.bfuResolvedBodyEndAccepted.getWidth == 1)
    assert(io.bfuResolvedBodyEndHeaderMismatch.getWidth == 1)
    assert(io.bfuResolvedBodyEndInactiveDrop.getWidth == 1)
    assert(io.bfuResolvedBodyEndFlushDrop.getWidth == 1)
    assert(io.bfuResolvedBodyEndUnderflow.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimeSelected.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceReplaySelected.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimeReplayComparable.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimeReplayMatch.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimeReplayMismatch.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimeFeedbackFire.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePending.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePendingConsumeFire.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePendingDropMismatch.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePendingCandidateComparable.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePendingCandidateMatch.getWidth == 1)
    assert(io.bfuResolvedBodyEndSourceRuntimePendingCandidateMismatch.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidateValid.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidatePendingWithoutActiveHeader.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidateActiveHeaderMismatch.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidateReplayComparable.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidateReplayMatch.getWidth == 1)
    assert(io.bfuPendingRuntimeCandidateReplayMismatch.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOraclePending.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOracleCaptureFire.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOracleReplayComparable.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOracleReplayMatch.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOracleReplayMismatch.getWidth == 1)
    assert(io.bfuRuntimeBodyEndOracleOverwritePending.getWidth == 1)
    assert(io.bfuStaticExternalComparable.getWidth == 1)
    assert(io.bfuStaticExternalMatch.getWidth == 1)
    assert(io.bfuStaticExternalMismatch.getWidth == 1)
    assert(io.bfuStaticExternalHeaderMismatch.getWidth == 1)
    assert(io.bfuStaticExternalHSizeMismatch.getWidth == 1)
    assert(io.bfuStaticExternalBSizeMismatch.getWidth == 1)
    assert(io.bfuBodyCutArmComparable.getWidth == 1)
    assert(io.bfuBodyCutArmAccepted.getWidth == 1)
    assert(io.bfuBodyCutArmMismatch.getWidth == 1)
    assert(io.bfuBodyCutArmHeaderMismatch.getWidth == 1)
    assert(io.bfuBodyCutArmHSizeMismatch.getWidth == 1)
    assert(io.bfuBodyCutArmBSizeMismatch.getWidth == 1)
  ...
  test("LinxCoreFrontendFetchRfAluTraceTop elaborates source, frontend, rename, RF, issue, ROB, and ALU execute") {
    ...
    assert(sv.contains("io_bfuStaticResolvedLearnedFire"))
    assert(sv.contains("io_bfuResolvedBodyEndAccepted"))
    assert(sv.contains("io_bfuResolvedBodyEndUnderflow"))
    assert(sv.contains("io_bfuResolvedBodyEndSourceRuntimeSelected"))
    assert(sv.contains("io_bfuResolvedBodyEndSourceRuntimeFeedbackFire"))
    assert(sv.contains("io_bfuResolvedBodyEndSourceRuntimePending"))
    assert(sv.contains("io_bfuResolvedBodyEndSourceRuntimePendingCandidateMatch"))
    assert(sv.contains("io_bfuPendingRuntimeCandidateReplayMatch"))
    assert(sv.contains("io_bfuPendingRuntimeCandidateActiveHeaderMismatch"))
    assert(sv.contains("io_bfuRuntimeBodyEndOracleReplayMatch"))
    assert(sv.contains("io_bfuRuntimeBodyEndOracleOverwritePending"))
    assert(sv.contains("io_bfuStaticExternalMatch"))
    assert(sv.contains("io_bfuStaticExternalBSizeMismatch"))
    assert(sv.contains("io_bfuBodyCutArmAccepted"))
    assert(sv.contains("io_bfuBodyCutArmBSizeMismatch"))
