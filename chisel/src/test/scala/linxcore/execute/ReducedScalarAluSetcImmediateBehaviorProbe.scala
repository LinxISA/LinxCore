...
class ReducedScalarAluSetcImmediateBehaviorProbeIO extends Bundle {
...
class ReducedScalarAluSetcImmediateBehaviorProbe extends Module {
  ...
  val io = IO(new ReducedScalarAluSetcImmediateBehaviorProbeIO)
  ...
  execute.io.in.insnLen := Mux(
    io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_ANDI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_EQI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_GEI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_GEUI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_LTI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_LTUI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_NEI.U ||
      io.opcode === FrontendOpcodeDecodeTable.OP_HL_SETC_ORI.U,
    6.U,
    4.U)
...
object EmitReducedScalarAluSetcImmediateBehaviorProbe extends App {
  val targetDir = args.sliding(2, 1).collectFirst {
    case Array("--target-dir", dir) => dir
  }.getOrElse("generated/chisel-verilog/backend-reduced-scalar-alu-setc-immediate-behavior-probe")

  ChiselStage.emitSystemVerilogFile(
    new ReducedScalarAluSetcImmediateBehaviorProbe,
