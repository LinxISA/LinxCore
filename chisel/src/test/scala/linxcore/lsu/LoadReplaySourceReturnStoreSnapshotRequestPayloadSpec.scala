...
object LoadReplaySourceReturnStoreSnapshotRequestPayloadReference {
  final case class Payload(
      ...
      rid: Int = 0,
      loadLsId: Int = 0,
      loadLsIdFullValid: Boolean = false,
  ...
  def apply(
      ...
      selectedLoadLsIdFullValid: Boolean = false,
      selectedLoadLsIdFull: BigInt = 0,
      selectedPeId: Int = 0,
      selectedStid: Int = 0,
      selectedTid: Int = 0,
      selectedPc: BigInt = 0,
    ...
    val payload =
      if (requestValid) {
        Payload(
          ...
          loadLsIdFullValid = selectedLoadLsIdFullValid,
          loadLsIdFull = selectedLoadLsIdFull,
          peId = selectedPeId,
          stid = selectedStid,
          tid = selectedTid,
          pc = selectedPc,
