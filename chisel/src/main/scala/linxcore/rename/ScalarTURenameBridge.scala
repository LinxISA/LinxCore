...
class ScalarTURenameBridgeIO(
  ...
  val tuRetirePeId = Input(UInt(peIdWidth.W))
  val tuRetireStid = Input(UInt(stidWidth.W))
...
class ScalarTURenameBridge(
  ...
  io.gprFreeFromLiveCount := scalar.io.gprFreeFromLiveCount
  io.gprFreeListMismatchCount := scalar.io.gprFreeListMismatchCount
  io.gprNextMapQValidCount := scalar.io.gprNextMapQValidCount
  ...
  io.tuRetirePeInRange := tu.io.retirePeInRange
  io.tuRetireStidInRange := tu.io.retireStidInRange
