...
class ScalarIssueFabricProbe(
  ...
  fabric.io.scalarSpHeadBidByStid(0).valid := true.B
  fabric.io.scalarSpHeadBidByStid(0).wrap := false.B
  fabric.io.scalarSpHeadBidByStid(0).value := 0.U
  fabric.io.scalarSpHeadRidByStid(0).valid := true.B
  fabric.io.scalarSpHeadRidByStid(0).wrap := false.B
  fabric.io.scalarSpHeadRidByStid(0).value := io.enqueueRid
