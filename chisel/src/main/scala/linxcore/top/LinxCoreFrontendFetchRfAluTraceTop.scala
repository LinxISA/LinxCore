...
class LinxCoreFrontendFetchRfAluTraceTop(
  ...
  reducedReplayLiqLaunchReadiness.io.scbReturned := false.B
  ...
  reducedLoadReplayLiqAllocPath.io.e2LoadDataReturned := reducedReplayLiqLaunchReadiness.io.baseDataReady
