...
object InterfaceManifest {
  ...
  private val endpointDefinitions = Seq(
    ...
    EndpointDefinition("ooo_to_iex_std", "IFC-OOO-IEX-001", "OOO", "IEX",
      _.iex.stdPipes, p => new DispatchTxn(p)),
    ...
    EndpointDefinition("iex_to_ooo_completion", "IFC-OOO-IEX-001", "IEX", "OOO",
      _.widths.issueWidth, p => new CompletionTxn(p)),
    EndpointDefinition("iex_to_lsu_load_address", "IFC-IEX-LSU-001", "IEX", "LSU",
      _.lsu.loadPipes, p => new LoadRequestTxn(p)),
