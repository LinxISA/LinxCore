...
class LinxCoreFrontendRfAluTraceTopIO(
...
object EmitLinxCoreFrontendRfAluTraceTop extends App {
  circt.stage.ChiselStage.emitSystemVerilogFile(
    new LinxCoreFrontendRfAluTraceTop(CoreParams(robEntries = 8, commitWidth = 2), mapQDepth = 8),
    args = Array("--target-dir", "../generated/chisel-verilog/frontend-rf-alu-trace-top"),
