...
def icache_config(
    ...
    *,
    ...
    if bundle_bits > (line_b * 8):
        raise ValueError("ifetch bundle width cannot exceed cache line width")
    ...
    spec = (
        ...
        .add("ifetch_bundle_bits", default=128, min_value=8)
        .add("ifetch_bundle_bytes", default=16, min_value=1)
...
def top_config(
    ...
    *,
    ...
    spec = (
        meta.params()
        .add("mem_bytes", default=1 << 20, min_value=1)
        .add("ic_sets", default=32, min_value=1)
        .add("ic_ways", default=4, min_value=1)
        .add("ic_line_bytes", default=64, min_value=8)
        .add("ifetch_bundle_bits", default=128, min_value=8)
