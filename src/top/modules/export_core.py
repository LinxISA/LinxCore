...
from .trace_event import (
    build_top_occ_block_special,
    build_top_occ_exec_mem,
    build_top_occ_frontend,
)
...
def build_top_export(
    ...
    *,
    ...
    # DFX pipeview occupancy probes remain on the pyc->debug_occ path, but the
    # per-stage/lane fanout now sits behind dedicated child modules so TopExport
    # no longer owns the full inline probe fabric.
    m.instance_auto(
        build_top_occ_frontend,
        name="top_occ_frontend",
        module_name="LinxCoreTopOccFrontend",
        tb_ifu_stub_enable=tb_ifu_stub_enable_top,
        tb_ifu_stub_valid=tb_ifu_stub_valid_top,
        ib_push_ready=ib_push_ready_top,
        tb_ifu_stub_pkt_uid=tb_ifu_stub_pkt_uid_top,
        tb_ifu_stub_pc=tb_ifu_stub_pc_top,
        ib_pop_valid=ib_top["pop_valid"],
        f4_pkt_uid=f4_pkt_uid_in_top,
        f4_pc=f4_pc_in_top,
        backend_ready=backend_ready_top,
    )

    m.instance_auto(
        build_top_occ_exec_mem,
        name="top_occ_exec_mem",
        module_name="LinxCoreTopOccExecMem",
        e1_valid0=c(0, width=1),
        e1_uid0=c(0, width=64),
        e1_pc0=c(0, width=64),
        e1_rob0=c(0, width=6),
        e1_valid1=c(0, width=1),
        e1_uid1=c(0, width=64),
        e1_pc1=c(0, width=64),
        e1_rob1=c(0, width=6),
        e1_valid2=c(0, width=1),
        e1_uid2=c(0, width=64),
        e1_pc2=c(0, width=64),
        e1_rob2=c(0, width=6),
        e1_valid3=c(0, width=1),
        e1_uid3=c(0, width=64),
        e1_pc3=c(0, width=64),
        e1_rob3=c(0, width=6),
        e2_valid=c(0, width=1),
        e2_uid=c(0, width=64),
        e2_pc=c(0, width=64),
        e2_rob=c(0, width=6),
        e3_valid=c(0, width=1),
        e3_uid=c(0, width=64),
        e3_pc=c(0, width=64),
        e3_rob=c(0, width=6),
        e4_valid=c(0, width=1),
        e4_pc=c(0, width=64),
        liq_valid=c(0, width=1),
        liq_uid=c(0, width=64),
        liq_pc=c(0, width=64),
        liq_rob=c(0, width=6),
        lhq_valid=c(0, width=1),
        lhq_uid=c(0, width=64),
        lhq_pc=c(0, width=64),
        lhq_rob=c(0, width=6),
        stq_valid=c(0, width=1),
        stq_uid=c(0, width=64),
        stq_pc=c(0, width=64),
        stq_rob=c(0, width=6),
        scb_valid=c(0, width=1),
        scb_uid=c(0, width=64),
        scb_pc=c(0, width=64),
        scb_rob=c(0, width=6),
        mdb_valid=c(0, width=1),
        mdb_pc=c(0, width=64),
        l1d_valid=c(0, width=1),
        l1d_uid=c(0, width=64),
        l1d_pc=c(0, width=64),
        l1d_rob=c(0, width=6),
    )
    ...
    m.instance_auto(
        build_top_occ_block_special,
        name="top_occ_block_special",
        module_name="LinxCoreTopOccBlockSpecial",
        bisq_valid=c(0, width=1),
        bisq_uid=c(0, width=64),
        bisq_pc=c(0, width=64),
        bisq_rob=c(0, width=6),
        bctrl_valid=c(0, width=1),
        bctrl_uid=c(0, width=64),
        bctrl_pc=c(0, width=64),
        bctrl_rob=c(0, width=6),
        tmu_valid=c(0, width=1),
        tmu_uid=c(0, width=64),
        tmu_pc=c(0, width=64),
        tmu_rob=c(0, width=6),
        tma_valid=c(0, width=1),
        tma_uid=c(0, width=64),
        tma_pc=c(0, width=64),
        tma_rob=c(0, width=6),
        cube_valid=c(0, width=1),
        cube_uid=c(0, width=64),
        cube_pc=c(0, width=64),
        cube_rob=c(0, width=6),
        vec_valid=c(0, width=1),
        vec_uid=c(0, width=64),
        vec_pc=c(0, width=64),
        vec_rob=c(0, width=6),
        tau_valid=c(0, width=1),
        tau_uid=c(0, width=64),
        tau_pc=c(0, width=64),
        tau_rob=c(0, width=6),
        brob_valid=c(0, width=1),
        brob_uid=c(0, width=64),
        brob_pc=c(0, width=64),
        brob_rob=c(0, width=6),
        fls_valid=flush_valid_fls | (~backend_top["replay_cause"].__eq__(c(0, width=8))),
        fls_pc=flush_pc_fls,
        bru_mismatch=c(0, width=1),
        bru_valid=c(0, width=1),
        bru_uid=c(0, width=64),
        bru_pc=c(0, width=64),
        bru_rob=c(0, width=6),
        bru_parent=c(0, width=64),
        redirect_from_corr=c(0, width=1),
        rob_redirect_valid=c(0, width=1),
        rob_uid=c(0, width=64),
        rob_pc=c(0, width=64),
        rob_rob=c(0, width=6),
        rob_parent=c(0, width=64),
        bru_fault_set=backend_top["bru_fault_set_dbg"],
        fls1_valid=backend_top["redirect_valid"] | backend_top["bru_fault_set_dbg"],
        fls1_pc=backend_top["redirect_pc"],
        template_valid=c(0, width=1),
        template_uid=c(0, width=64),
        template_pc=c(0, width=64),
        template_parent=c(0, width=64),
    )
