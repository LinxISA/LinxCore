...
def build_bru_recovery_bridge(
    ...
    *,
    ...
    bru_target = state_br_base_pc + state_br_off
    bru_target = state_br_kind.__eq__(c(BK_RET, width=3))._select_internal(state_commit_tgt, bru_target)
    ...
    m.output("bru_mismatch_evt", bru_recovery_owner["bru_mismatch_evt"])
    m.output("bru_corr_set", bru_recovery_owner["bru_corr_set"])
    m.output("bru_corr_take", bru_recovery_owner["bru_corr_take"])
    m.output("bru_corr_target", bru_recovery_owner["bru_corr_target"])
    m.output("bru_corr_checkpoint_id", bru_recovery_owner["bru_corr_checkpoint_id"])
