...
def build_janus_bcc_bctrl_brenu(m: Circuit) -> None:
    ...
    epoch_roll_brenu = issue_fire_brenu & tag_ctr_brenu.out().__eq__(c(0xFF, width=8))
    ...
    bid_brenu = (issued_ctr_brenu.out()._zext(width=64).shl(amount=slot_w_brenu)) | slot_id_brenu._zext(width=64)
