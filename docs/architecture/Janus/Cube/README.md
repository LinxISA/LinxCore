...
### 架构图
- **[diagrams/cube_pipeline.md](diagrams/cube_pipeline.md)** - CUBE 内部模块和流水线
  - 顶层模块框图
  - 详细流水线阶段
  - 数据通路宽度和带宽
  - 关键路径分析
...
### 归档（旧版本）
- **[archive_v1_superscalar/](archive_v1_superscalar/)** - 旧版 CUBE 文档（superscalar 风格）
...
2. 阅读 [diagrams/cube_pipeline.md](diagrams/cube_pipeline.md) - 可视化架构

### RTL 工程师
1. 阅读 [architecture.md](architecture.md) - 架构合约
2. 阅读 [diagrams/cube_pipeline.md](diagrams/cube_pipeline.md) - 模块和流水线
3. 等待实现细节文档完成
...
| diagrams/cube_pipeline.md | ✅ 完成 | 392 | 2026-06-02 |
| datapath.md | ✅ 完成 | 769 | 2026-06-02 |
| isq.md | ✅ 完成 | 633 | 2026-06-02 |
| l0cache.md | ✅ 完成 | 685 | 2026-06-02 |
| accumulator.md | ✅ 完成 | 605 | 2026-06-02 |
| acccvt.md | ✅ 完成 | 638 | 2026-06-02 |
...
### DavinciOO 参考（归档）
- `archive_v1_superscalar/` - 旧版 CUBE 实现参考
