...
| B-SIDE | 取消 prediction request/response；canonical prune 恢复 request-owned GHR/GHRQ/RAS checkpoint、追加 actual/corrected conditional delta 或应用 Call/Return delta 并清除年轻项；path history 复用同一恢复顺序 |
