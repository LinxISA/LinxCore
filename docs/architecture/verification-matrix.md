...
| LinxCore | `LinxCore::focused LSU promotion` | `bash rtl/LinxCore/tests/test_lsu_promotion.sh` | pyCircuit SCB coalescing, request stability, and completion in C++/Verilator plus focused Chisel forwarding, replay, STQ/SCB, and MDB suites, including unequal physical STQ/ROB/full-LSID width contracts |
