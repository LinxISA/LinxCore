...
- B-F1..B-F4 correction of an accepted lower-ranked prediction generates an
  ...
  returned canonical prune restores request-owned GHR/RAS, applies the
  corrected conditional or Call/Return delta, and restarts I-F0; B-F4 is the final such point.
