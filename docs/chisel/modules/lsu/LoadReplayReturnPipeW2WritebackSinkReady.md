...
| input | `liveEnable` | Future live W2 replay writeback enable. Current top ties this low. |
...
RF write port cannot arm a writeback request. With `liveEnable=false`, the
