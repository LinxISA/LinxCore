...
The R347 integration remains observational. It does not feed W2 readiness, W2
slot clear, ROB resolve mutation, replay RF writeback, ready-table mutation,
issue wakeup, or replay-row lifecycle.
