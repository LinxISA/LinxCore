...
- R378 LRET sink readiness from `ScalarLSULoadReturnQueueBank.enqueueReady`;
...
BUILD_DIR=generated/r315-replay-side-effect-ready-xcheck bash tools/chisel/run_chisel_frontend_trace_top_xcheck.sh
```
