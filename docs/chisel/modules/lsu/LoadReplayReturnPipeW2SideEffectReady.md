...
and missing-ready masks plus a `matchesReadyJoin` diagnostic, but it does not
replace this module or feed W2 clear.
...
```
Provenance: source commit 7c6d65970809b6b7025298c2536ed512db9b7ede.
