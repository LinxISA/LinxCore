...
that readiness gate, while keeping the pipe mask empty. `launchEnable`
therefore remains low while source-return and return-port blockers are visible
as diagnostics.
