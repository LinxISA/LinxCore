...
issue-wakeup capacity, while the replay writeback arbiter also remains
disabled. The side-effect predicate therefore reports real LRET capacity and
named wakeup blockers but remains unable to enable live replay state mutation.
