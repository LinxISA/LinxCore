...
completion is held low because the current top still ties W2 side-effect
readiness false.
...
and now owns the W2 clear pulse. The current top ties W2 side-effect readiness
low, so completion and clear remain dormant until live sinks are wired.
