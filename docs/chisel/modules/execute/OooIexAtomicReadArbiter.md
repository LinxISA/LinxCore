...
source is absent from the RF mask. A larger case proves the oldest complete
groups win when requests exceed available P ports.
...
- Synthesize and place the rank/greedy hierarchy at the canonical topology; add a
