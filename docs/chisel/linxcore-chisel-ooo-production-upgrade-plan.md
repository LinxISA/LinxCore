...
| O3 grouped ROB/BROB/PC | In progress | combinational D2 virtual group planner; exact wrap-aware RID keys; parent/member caps; block/PC-release splits; O0/O1 retained D2/D3/S1 shell | retained D2 transaction, D3 reservation, atomic S1 publication, grouped completion, BROB, and PC-buffer storage |
