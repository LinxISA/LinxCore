...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R61 reduced frontend decode to queued scalar rename, ROB/BROB allocation, queue-backed STQ path, T/U cleanup diagnostics, and disabled T/U producer defaults |
