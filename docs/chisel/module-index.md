...
|---|---|---|---|
| `InterfaceBundles` / `TULinkBundles` | `linxcore.common` | `docs/chisel/interfaces/CommonBundles.md` | Unit-green shared type packets including R56 T/U cleanup source and R63 retire-source/command bundles |
...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R73 reduced frontend decode to queued scalar plus T/U rename, ROB/BROB allocation, queue-backed STQ path, live ROB deallocation T/U retire-command path, scalar block-clean scheduling, bridge-owned selected-STID local block-commit fanout, and queued-row STID active-bank selector diagnostics |
...
| `ScalarTURenameBridge` | `linxcore.rename` | `docs/chisel/modules/rename/ScalarTURenameBridge.md` | Unit-green R73 scalar-GPR plus T/U bank-array composition owner with atomic accept, T/U operand overlay, live sequence sidecars, explicit active-bank selector inputs, retire-command acceptance feedback, and selected-STID local block-commit fanout |
...
| `TULinkRelationCmap` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRelationCmap.md` | Unit-green R65 SPEROB relation-cmap retire/release command producer with mark-before-release, pressure release, block-last drain, and cleanup pruning policy |
| `TULinkRetireCommandPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRetireCommandPath.md` | Unit-green R70 width-aware ROB deallocation T/U retire-source serializer with post-drain scalar block-clean scheduling and post-clean BID/STID local block-commit event boundary |
...
| `TULinkLocalBankArray` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkLocalBankArray.md` | Unit-green R73 explicit `[scalar PE][STID]` T/U local-register bank-group array with bridge-owned fanout and queued-row STID active-bank routing for the reduced PE0 lane |
