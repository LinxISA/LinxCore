...
|---|---|---|---|
| `InterfaceBundles` / `TULinkBundles` | `linxcore.common` | `docs/chisel/interfaces/CommonBundles.md` | Unit-green shared type packets including R56 T/U cleanup source and R74 retire-source/command PE/STID sidecars |
...
| `ReducedScalarRegisterFile` | `linxcore.execute` | `docs/chisel/modules/execute/ReducedScalarRegisterFile.md` | Unit-green R82 reduced physical scalar RF/ready owner for renamed-tag ALU source data and writeback |
| `ReducedScalarIssueQueue` | `linxcore.execute` | `docs/chisel/modules/execute/ReducedScalarIssueQueue.md` | Unit-green R83 reduced FIFO scalar issue boundary with RF head-readiness gating and queued dependent-row xcheck |
...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R74 reduced frontend decode to queued scalar plus T/U rename, ROB/BROB allocation, queue-backed STQ path, live ROB deallocation T/U retire-command path with retired-row PE/STID routing, scalar block-clean scheduling, bridge-owned selected-STID local block-commit fanout, and queued-row STID active-bank selector diagnostics |
...
| `ROBEntryBank` | `linxcore.rob` | `docs/chisel/modules/rob/ROBEntryBank.md` | Unit-green R74 integrated ROB/CMT entry-bank skeleton with flush application, native row IDs, ROB T/U sidecars, deallocation T/U retire-source PE/STID vector, and block-last dealloc stop |
...
| `LinxCoreFrontendRfAluTraceTop` | `linxcore.top` | `docs/chisel/modules/top/LinxCoreFrontendRfAluTraceTop.md` | Unit-green R83 frontend packet to RF-backed queued ALU completion-row generated-RTL xcheck with dependent scalar rows |
