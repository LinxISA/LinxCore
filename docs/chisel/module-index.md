...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R71 reduced frontend decode to queued scalar plus T/U rename, ROB/BROB allocation, queue-backed STQ path, live ROB deallocation T/U retire-command path, scalar block-clean scheduling, and selected-STID local block-commit fanout |
...
| `ScalarTURenameBridge` | `linxcore.rename` | `docs/chisel/modules/rename/ScalarTURenameBridge.md` | Unit-green R70 scalar-GPR plus T/U rename composition owner with atomic accept, T/U operand overlay, live sequence sidecars, retire-command acceptance feedback, and STID-filtered local block-commit event consumption |
...
| `TULinkLocalBlockCommitFanout` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkLocalBlockCommitFanout.md` | Unit-green R71 selected-STID local block-commit fanout boundary with atomic all-selected-PE readiness and reduced 1-PE/1-STID integration |
...
| `TULinkRecoveryCleanupPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRecoveryCleanupPath.md` | Unit-green R70 composition of ROB/LSU source selection, T/U flush sequence publishing, local-register rename cleanup, STID-filtered local block-commit consumption, and source-error recovery barrier |
