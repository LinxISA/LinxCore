...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R57 reduced frontend decode to queued scalar rename, ROB/BROB allocation, queue-backed store dispatch handoff, and ROB T/U source observability |
