...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R64 reduced frontend decode to queued scalar plus T/U rename, ROB/BROB allocation, queue-backed STQ path, and live ROB deallocation T/U retire-command path |
...
| `TULinkRelationCmap` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRelationCmap.md` | Unit-green R63 SPEROB relation-cmap retire/release command producer with mark-before-release, pressure release, and block-last drain policy |
| `TULinkRetireCommandPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRetireCommandPath.md` | Unit-green R64 width-aware ROB deallocation T/U retire-source serializer feeding relation-cmap commands into live T/U rename acceptance |
