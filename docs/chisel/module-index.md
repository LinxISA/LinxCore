...
| `DecodeRenameROBPath` | `linxcore.backend` | `docs/chisel/modules/backend/DecodeRenameROBPath.md` | Unit-green R69 reduced frontend decode to queued scalar plus T/U rename, ROB/BROB allocation, queue-backed STQ path, live ROB deallocation T/U retire-command path, scalar block-clean scheduling, and consumed local block-commit event |
...
| `ScalarTURenameBridge` | `linxcore.rename` | `docs/chisel/modules/rename/ScalarTURenameBridge.md` | Unit-green R69 scalar-GPR plus T/U rename composition owner with atomic accept, T/U operand overlay, live sequence sidecars, retire-command acceptance feedback, and local block-commit event consumption |
...
| `TULinkRetireCommandPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRetireCommandPath.md` | Unit-green R68 width-aware ROB deallocation T/U retire-source serializer with post-drain scalar block-clean scheduling and post-clean local block-commit event boundary |
...
| `TULinkRecoveryCleanupPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRecoveryCleanupPath.md` | Unit-green R69 composition of ROB/LSU source selection, T/U flush sequence publishing, local-register rename cleanup, local block-commit consumption, and source-error recovery barrier |
