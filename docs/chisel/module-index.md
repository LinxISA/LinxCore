...
| `TULinkRetireCommandPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRetireCommandPath.md` | Unit-green R65 width-aware ROB deallocation T/U retire-source serializer feeding relation-cmap commands into live T/U rename acceptance with source/relation cleanup pruning |
