...
| `TULinkRecoveryCleanupPath` | `linxcore.rename` | `docs/chisel/modules/rename/TULinkRecoveryCleanupPath.md` | Unit-green R54 composition of T/U flush sequence publishing with local-register rename cleanup and source-error recovery barrier |
