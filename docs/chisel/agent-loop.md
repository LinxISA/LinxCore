...
1. Scale the admitted-marker CoreMark gate beyond the R227 6000-row window.
   ...
   extends the same admitted-marker path on clean pushed LinxCore/Model/QEMU
   SHAs to 6000 raw QEMU rows, 5866 expected rows, 728 filtered marker commits,
   5137 compared normalized rows, and zero mismatches. The next packet should
   grow beyond the 6000-row window while watching block-stop cleanup BID
