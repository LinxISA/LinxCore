...
2. Promote beyond the R147 BFU resolved-geometry diagnostic boundary. The reduced
   ...
   payload. The next packet should add a real branch-resolution/body-end owner
