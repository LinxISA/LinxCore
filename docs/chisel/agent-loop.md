...
1. Scale the admitted-marker CoreMark gate beyond the R231 24576-row window.
   ...
   R228, R229, R230, and R231 extend the same admitted-marker path on clean
   pushed LinxCore/Model/QEMU SHAs to 6000, 8192, 12288, 16384, and 24576 raw
   QEMU rows; the latest run extracts 24442 expected rows, filters 2055 marker
   commits, compares 22386 normalized rows, and passes with zero mismatches.
   The next packet should grow beyond the 24576-row window while watching block-stop cleanup BID
   ...
   `generated/r230-row-order-16384-marker-qemu-elf-xcheck`, or the latest
