...
1. Scale the admitted-marker CoreMark gate beyond the R235 98304-row window.
   ...
   R228, R229, R230, R231, R232, R233, R234, and R235 extend the same admitted-marker path
   on clean pushed LinxCore/Model/QEMU SHAs to 6000, 8192, 12288, 16384, 24576,
   32768, 49152, 65536, and 98304 raw QEMU rows; the latest run extracts 98170 expected
   rows, filters 7321 marker commits, compares 90848 normalized rows, and passes
   with zero mismatches. The next packet should grow beyond the 98304-row
   ...
   `generated/r234-row-order-65536-marker-qemu-elf-xcheck`, or the latest
