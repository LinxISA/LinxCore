...
1. Scale the admitted-marker CoreMark gate beyond the R232 32768-row window.
   ...
   R228, R229, R230, R231, and R232 extend the same admitted-marker path on
   clean pushed LinxCore/Model/QEMU SHAs to 6000, 8192, 12288, 16384, 24576,
   and 32768 raw QEMU rows; the latest run extracts 32634 expected rows,
   filters 2640 marker commits, compares 29993 normalized rows, and passes
   with zero mismatches. The next packet should grow beyond the 32768-row
   ...
   `generated/r231-row-order-24576-marker-qemu-elf-xcheck`, or the latest
