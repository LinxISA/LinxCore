...
|---|---|---|---|---|---:|---|---:|---:|
| W2 | `top_io` | [[IFC-TOP-EXT-002]] | Platform | TOP | 1 | `TOPIO` | 520 | 12892 |
...
| W2 | `iex_to_lsu_store_reservation` | [[IFC-IEX-LSU-001]] | IEX | LSU | 2 | `StoreReservationTxn` | 26 | 454 |
...
| W2 | `lsu_internal_store_classify` | [[IFC-IEX-LSU-001]] | LSU Translation | LSU Commit Backend | 1 | `StoreMemoryClassifyTxn` | 16 | 254 |
...
| W2 | `ooo_commit` | [[IFC-COMMIT-001]] | OOO | TOP/DTU | 2 | `CommitTxn` | 181 | 2776 |
...
| W4 | `top_io` | [[IFC-TOP-EXT-002]] | Platform | TOP | 1 | `TOPIO` | 740 | 16416 |
...
| W4 | `iex_to_lsu_store_reservation` | [[IFC-IEX-LSU-001]] | IEX | LSU | 2 | `StoreReservationTxn` | 26 | 454 |
...
| W4 | `lsu_internal_store_classify` | [[IFC-IEX-LSU-001]] | LSU Translation | LSU Commit Backend | 1 | `StoreMemoryClassifyTxn` | 16 | 254 |
...
| W4 | `ooo_commit` | [[IFC-COMMIT-001]] | OOO | TOP/DTU | 4 | `CommitTxn` | 361 | 5551 |
...
| W6 | `top_io` | [[IFC-TOP-EXT-002]] | Platform | TOP | 1 | `TOPIO` | 960 | 19938 |
...
| W6 | `iex_to_lsu_store_reservation` | [[IFC-IEX-LSU-001]] | IEX | LSU | 2 | `StoreReservationTxn` | 26 | 454 |
...
| W6 | `lsu_internal_store_classify` | [[IFC-IEX-LSU-001]] | LSU Translation | LSU Commit Backend | 1 | `StoreMemoryClassifyTxn` | 16 | 254 |
...
| W6 | `ooo_commit` | [[IFC-COMMIT-001]] | OOO | TOP/DTU | 6 | `CommitTxn` | 541 | 8325 |
...
| W8 | `top_io` | [[IFC-TOP-EXT-002]] | Platform | TOP | 1 | `TOPIO` | 1180 | 23462 |
...
| W8 | `iex_to_lsu_store_reservation` | [[IFC-IEX-LSU-001]] | IEX | LSU | 2 | `StoreReservationTxn` | 26 | 454 |
...
| W8 | `lsu_internal_store_classify` | [[IFC-IEX-LSU-001]] | LSU Translation | LSU Commit Backend | 1 | `StoreMemoryClassifyTxn` | 16 | 254 |
...
| W8 | `ooo_commit` | [[IFC-COMMIT-001]] | OOO | TOP/DTU | 8 | `CommitTxn` | 721 | 11100 |
