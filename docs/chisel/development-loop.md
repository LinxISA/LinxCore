...
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `build_frontend_fetch_rf_alu_qemu_fixture_elf.sh --out-dir generated/r100-live-qemu-fixture`<!-- task15-historical-specialized-evidence:end -->
and
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `run_chisel_frontend_fetch_rf_alu_qemu_elf_xcheck.sh --elf generated/r100-live-qemu-fixture/frontend_fetch_rf_alu_qemu_fixture.elf --expected-rows 3 --capture-rows 3 --pc-lo 0x10002 --pc-hi 0x1000b --max-seconds 5`<!-- task15-historical-specialized-evidence:end -->
...
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `build_frontend_fetch_rf_alu_qemu_fixture_elf.sh --out-dir generated/r101-live-qemu-fixture`<!-- task15-historical-specialized-evidence:end -->
and
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `run_chisel_frontend_fetch_rf_alu_qemu_elf_xcheck.sh --elf generated/r101-live-qemu-fixture/frontend_fetch_rf_alu_qemu_fixture.elf --expected-rows 0 --capture-rows 5 --allow-block-markers --max-seconds 5`<!-- task15-historical-specialized-evidence:end -->
...
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `build_frontend_fetch_rf_alu_qemu_fixture_elf.sh --out-dir generated/r102-live-qemu-fixture`<!-- task15-historical-specialized-evidence:end -->,
...
control. Evidence:
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `build_frontend_fetch_rf_alu_qemu_fixture_elf.sh --out-dir generated/r104-live-qemu-fixture`<!-- task15-historical-specialized-evidence:end -->
and
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `run_chisel_frontend_fetch_rf_alu_qemu_elf_xcheck.sh --build-dir generated/r104-marker-lifecycle-qemu-elf-xcheck --elf generated/r104-live-qemu-fixture/frontend_fetch_rf_alu_qemu_fixture.elf --expected-rows 0 --capture-rows 5 --allow-block-markers --max-seconds 5`<!-- task15-historical-specialized-evidence:end -->
...
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `build_frontend_fetch_rf_alu_qemu_fixture_elf.sh --out-dir generated/r105-long-body-fixture --long-body`<!-- task15-historical-specialized-evidence:end -->
and
<!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `run_chisel_frontend_fetch_rf_alu_qemu_elf_xcheck.sh --build-dir generated/r105-long-body-qemu-elf-xcheck --elf generated/r105-long-body-fixture/frontend_fetch_rf_alu_qemu_fixture.elf --expected-rows 0 --capture-rows 9 --allow-block-markers --max-seconds 5`<!-- task15-historical-specialized-evidence:end -->
...
| 3 | R78 trace replay xcheck harness | `tools/chisel/reduced_rob_trace_tb.cpp`, <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `tools/chisel/run_chisel_trace_replay_xcheck.sh`<!-- task15-historical-specialized-evidence:end -->, wrapper docs | <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `run_chisel_trace_replay_xcheck.sh`<!-- task15-historical-specialized-evidence:end -->, top xcheck, trace self-test, QEMU dry-run |
...
| 16 | R90 QEMU trace replay harness | <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `tools/chisel/run_chisel_qemu_trace_replay_xcheck.sh`<!-- task15-historical-specialized-evidence:end -->, trace replay wrapper docs | dry-run, archived/fresh QEMU JSONL replay with metadata-aware raw prefix, manifest inspection |
| 17 | R91 bounded CoreMark ELF replay prefix | <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `tools/chisel/run_chisel_qemu_trace_replay_xcheck.sh`<!-- task15-historical-specialized-evidence:end -->, trace replay wrapper docs | default-memory fail-fast check, CoreMark `--elf` replay with explicit `-m 1280M`, manifest inspection |
...
| 26 | R100 live QEMU capture plus reduced-row selection | <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `tools/chisel/run_chisel_frontend_fetch_rf_alu_qemu_elf_xcheck.sh`<!-- task15-historical-specialized-evidence:end -->, <!-- task15-historical-specialized-evidence:start -->historical evidence only (no current runnable equivalent): `tools/chisel/build_frontend_fetch_rf_alu_qemu_fixture_elf.sh`<!-- task15-historical-specialized-evidence:end -->, live fetch RF/ALU harness/docs | bounded QEMU trace capture, `FETCH_QEMU_TRACE` plus `FETCH_ELF`, row-derived RF preload regression, manifest inspection, explicit unsupported-row report |
